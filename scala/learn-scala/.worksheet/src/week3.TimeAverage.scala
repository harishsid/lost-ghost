...
object TimeAverage {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(79); 
  println("Welcome to the Scala worksheet");$skip(32); 

  val l1 = LapTime("20:20:80");System.out.println("""l1  : week3.LapTime = """ + $show(l1 ));$skip(31); 
  val l2 = LapTime("40:40:80");System.out.println("""l2  : week3.LapTime = """ + $show(l2 ));$skip(20); 
  val l3 = l1 <> l2;System.out.println("""l3  : week3.LapTime = """ + $show(l3 ));$skip(14); 
  val a = 'c';System.out.println("""a  : Char = """ + $show(a ))}
