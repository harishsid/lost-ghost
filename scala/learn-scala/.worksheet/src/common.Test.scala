...
object Test {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(73); 
  println("Welcome to the Scala worksheet");$skip(512); 
   ...
   def times(chars: List[Char]): List[(Char, Int)] = {
    ...
    times("acbcbabcaabdz".toList);System.out.println("""res0: List[(Char, Int)] = """ + $show(res$0));$skip(31); 
    
    val a = 1 :: 2 :: Nil;System.out.println("""a  : List[Int] = """ + $show(a ));$skip(169); 
    ...
    };System.out.println("""isort: (xs: List[Int])List[Int]""");$skip(34); val res$1 = 
    
    isort(List(2,9,4,3,7,9));System.out.println("""res1: List[Int] = """ + $show(res$1))}
